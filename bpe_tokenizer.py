...
class Dom1Tokenizer(BaseTokenizer):
    # This domain consists on twitter posts
    def __init__(self, vocab_size: int = 5000):
        ...
        super().__init__()
        self.space_token = "_"
        # special stuff from this domain would be:
            # @, http://, ..., ...., ....., ......, ......., (:, !, !!, !!!, !!!!, !!!!!, ;), &, $, #, tinyurl
        self.strudel_token = "@" # @blabla 
        self.website_token = "http://"
    ...
    def train(self, texts: List[str]) -> None:
        ...
        # Perform BPE merges
        num_merges = self.vocab_size - len(self.token_to_id) # how many merges we need to perform :) (this is the k we talked about)
...
class Dom2Tokenizer(BaseTokenizer): 
    # This domain consists in text coming from newspapers\magazines
    def __init__(self, vocab_size: int = 5000):
        """
        Initialize the BPE tokenizer
...
class UnkTokenizer(BaseTokenizer):
    def __init__(self, vocab_size: int = 5000):
        """
        Initialize the BPE tokenizer
