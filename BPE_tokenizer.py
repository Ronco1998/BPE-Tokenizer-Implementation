...
class BPETokenizer(BaseTokenizer):
    ...
    def _perform_word_merges(
        ...
        while word_merges_completed < word_merges and word_bigram_heap:
            ...
            # Add merged bigram to vocabulary if not already present
            if merged_bigram not in self.token_to_id:
                idx = len(self.token_to_id)
                self.token_to_id[merged_bigram] = idx
                self.id_to_token[idx] = merged_bigram
